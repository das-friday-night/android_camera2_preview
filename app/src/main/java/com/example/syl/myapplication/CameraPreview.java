...
public class CameraPreview {
     ...
     */
    private static final String TAG = "Camera2_Preview";
...
//            mCameraOpenCloseLock.release();
     ...
     *                          class
     * @param mTextureViewWidth  The width of the texture view relative to sensor coordinate
     * @param mTextureViewHeight The height of the texture view relative to sensor coordinate
    ...
    public void openCamera(int width, int height) {
        // width, height 分别是texture view的width 和 height
...
//            }
        ...
        String mCameraId = setUpCameraOutputs(width, height);
        configureTransform(width, height);

        // setup finish, ready to open camera
        CameraManager manager = (CameraManager) activity.getSystemService(Context.CAMERA_SERVICE);
        try {
            //打开相机，第一个参数指示打开哪个摄像头，第二个参数mStateCallback为相机的状态回调接口，
            //第三个参数用来确定mStateCallback在哪个线程执行，为null的话就在当前线程执行
